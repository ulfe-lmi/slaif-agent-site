...
| §§15.4, 21.7–22.5, 24.6–24.7, 26–27, 30.6 | Bounded Agent component catalog/composition/design data plane with shared preview and browser evidence | External agent + human preview / REST/OpenAPI → Render/Web → browser worker | Objective 078-j on open [PR #77](https://github.com/ulfe-lmi/slaif-agent-site/pull/77) preserves the immutable component/local-design slice and repairs initial design selection, exact scalar/responsive property scopes, removal/replay/no-effect accounting, route-policy/OpenAPI bidirectionality, and existing Button/Image/CollectionGrid visual classification, with final narrowed-capability/direct-helper/PostgreSQL/Render/Web/Puck and remote CI evidence recorded by the closing report. Site-theme, global-region, exact-workspace Puck, review, and publication remain outside this slice. | PARTIAL | Preserve the 078-j evidence for strategic review; site-theme/global behavior proceeds in a new PR after acceptance |
...
| 078 source revision | Public capability-bound catalog composition data plane plus the active 078-j repaired design-system/local variant-layout-responsive extension on open PR #77 | Remaining design/theme/global-region semantics, exact-workspace Puck, media references, MCP, freeze/review, promotion/publication, source reconstruction, cleanup, backup/restore, or contractual MVP completion |
