...
| §§15.4, 21.7–22.5, 24.6–24.7, 26–27, 30.6 | Bounded Agent component/design/theme data plane with shared preview and browser evidence | External agent + human preview / REST/OpenAPI → Render/Web → browser worker | Objective 078-f on open [PR #77](https://github.com/ulfe-lmi/slaif-agent-site/pull/77) proves the immutable component/composition slice. 078-g added typed `design-system/v1`, 078-h repaired exact scalar/responsive property scopes and visual classification, and active 078-i adds typed theme schema/defaults, COW mutation, resource/scope/idempotency/audit/concurrency semantics, and shared Render/Web/Puck consumption, with the complete focused proof and remote gates pending. Global regions/header-footer, exact-workspace Puck, review, and publication remain outside this slice. | PARTIAL | Preserve 078-f/h; complete 078-i focused/remote evidence, then later rounds cover remaining global behavior |
...
| 078 source revision | Public capability-bound catalog composition data plane plus 078-h repaired design-system/local variant-layout-responsive semantics and active 078-i bounded site-theme tokens on open PR #77 | Remaining global-region/header-footer/page-style semantics, exact-workspace Puck, media references, MCP, freeze/review, promotion/publication, source reconstruction, cleanup, backup/restore, or contractual MVP completion |
