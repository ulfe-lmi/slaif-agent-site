...
AFTER MERGED 078/1-078/4:
Global-region/header-footer increment opened at 078-5-a (PR pending);
remaining catalog breadth stays a separate increment; 078-i theme history is
preserved and was reused within the bounded 078/2 continuation.
