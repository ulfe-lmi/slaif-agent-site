...
| §§15.4, 21.7–22.5, 24.6–24.7, 26–27, 30.6 | Bounded Agent component catalog/composition/design data plane with shared preview and browser evidence | External agent + human preview / REST/OpenAPI → Render/Web → browser worker | Objective 078-f on open [PR #77](https://github.com/ulfe-lmi/slaif-agent-site/pull/77) proves the immutable component/composition slice. 078-g added typed `design-system/v1`, local variant/layout/responsive behavior; active 078-h repairs exact scalar/responsive property scopes, route-policy/OpenAPI bidirectionality, no-op accounting, and existing Button/Image/CollectionGrid visual classification, with narrowed-capability/direct-helper/PostgreSQL/Render/Web/Puck proof pending final gates. Site-global theme, global-region, exact-workspace Puck, review, and publication remain outside this slice. | PARTIAL | Preserve 078-f/g; complete 078-h focused/remote evidence, then later rounds cover remaining theme/global behavior |
...
| 078 source revision | Public capability-bound catalog composition data plane plus the active 078-h repaired design-system/local variant-layout-responsive extension on open PR #77 | Remaining design/theme/global-region semantics, exact-workspace Puck, media references, MCP, freeze/review, promotion/publication, source reconstruction, cleanup, backup/restore, or contractual MVP completion |
