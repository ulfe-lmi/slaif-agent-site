...
| §§15.4, 21.7–22.5, 24.6–24.7, 26–27, 30.6 | Bounded Agent component catalog/composition/design data plane with shared preview and browser evidence | External agent + human preview / REST/OpenAPI → Render/Web → browser worker | Objective 078-k on open [PR #77](https://github.com/ulfe-lmi/slaif-agent-site/pull/77) preserves the immutable component/local-design slice and closes full validation, responsive CREATE, renderer cascade, human Editor/Puck preservation, exact scalar/responsive property scopes, removal/replay/no-effect accounting, route-policy/OpenAPI bidirectionality, and migration reversibility, with final narrowed-capability/direct-helper/PostgreSQL/Render/Web/Puck evidence recorded by the closing report. Site-theme, global-region, exact-workspace Puck, review, and publication remain outside this slice. | PARTIAL | Preserve the 078-k evidence for strategic review; site-theme/global behavior proceeds in a new PR after acceptance |
...
| 078 source revision | Public capability-bound catalog composition data plane plus the active 078-k repaired design-system/local variant-layout-responsive extension on open PR #77 | Remaining design/theme/global-region semantics, exact-workspace Puck, media references, MCP, freeze/review, promotion/publication, source reconstruction, cleanup, backup/restore, or contractual MVP completion |
