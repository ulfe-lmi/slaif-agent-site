...
| §§15.7, 30, 52.7–52.8 | Immutable media bytes, private staging, public finalization, replaceable store | Agent/human Media service and review worker | Objective 070 proves immutable human upload/CAS safety; Agent upload/reference semantics, anonymous canonical-reference-gated bytes, real image rendering and promotion finalization are absent | PARTIAL | 079/1: Agent media create/reference, public/preview media core, promotion-callable finalization primitive, real Image rendering; 083: promotion-time finalization call, anonymous public reads gated on the accepted revision, rollback |
...
| 078 source revision | Public capability-bound catalog composition data plane plus accepted 078/1–078/4 revisions merged in PRs #77, #79, #80, and #81; the 078/4 page-style proof closure (078-v through 078-y) follows 078-v's rejected completion claim and the 078-w/078-x evidence repairs | Remaining global-region/catalog semantics, exact-workspace Puck, media references, MCP, freeze/review, promotion/publication, source reconstruction, cleanup, backup/restore, or contractual MVP completion |
      ...
      -> 075 complete editable-domain substrate and shared validators
          -> 076 Agent model/content/view/relation REST+OpenAPI
              -> 077 page/navigation/redirect/dynamic-Render (PR74 merged ae3a4a6)
                  -> 078/1 component composition/local design (PR77 merged 3cae3d6)
                      -> 078/2 site-theme token data plane (PR79 merged a9d3e68)
                          -> 078/3 browser security refresh (PR80 merged fe31c9f)
                              -> 078/4 page-style overrides (PR81 merged 26cafc1)

AFTER MERGED 078/1-078/5:
Global-region/header-footer increment accepted and merged in PR #85 at
2746c9f08c00fd84dff59bfd1536ce7319e16ff9 on 2026-09-19; remaining catalog
breadth stays a separate increment; 078-i theme history is preserved and was
