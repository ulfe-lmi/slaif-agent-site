...
**Authoritative audited source revision:** Active Objective 078-u browser scan-coverage maintenance on branch `oap/078-3-browser-security-refresh`, based on verified merged `main` `a9d3e6800d5e8b5fd5c9cd9e0be5010184058c6b` after accepted PR #79; the accepted Objective 078/1 and 078/2 source revisions are merged and GitHub state remains authoritative
...
| §§15.4, 21.7–22.5, 24.6–24.7 | Agent pages/routes/navigation/redirects/composition/design/media-reference semantics | External agent / REST/OpenAPI | Protocol-final 077-z source revision developed on [PR #74](https://github.com/ulfe-lmi/slaif-agent-site/pull/74) maps 077-a through 077-z to real public Agent/Editor/Render/NGINX/browser, PostgreSQL, migration, concurrency, recovery, OpenAPI/policy, and hostile-negative evidence for the bounded page/locale/navigation/redirect/dynamic-Render surface. It was accepted and merged on 2026-09-08 at `ae3a4a6`. Composition, design, media-reference, review, and publication remain outside 077. | COMPLETE — E2E PROVEN (source revision) | Preserve accepted 077 evidence; 078–091 remain separate contracts |
| §§15.4, 21.7–22.5, 24.6–24.7, 26–27, 30.6 | Bounded Agent component catalog/composition/design data plane with shared preview and browser evidence | External agent + human preview / REST/OpenAPI → Render/Web → browser worker | Accepted Objective 078/1 on merged [PR #77](https://github.com/ulfe-lmi/slaif-agent-site/pull/77), including the 078-o Next.js 16.3.3 security qualification, remains the source for component/local-design behavior. The 078/2 bounded site-theme closure was accepted and merged in [PR #79](https://github.com/ulfe-lmi/slaif-agent-site/pull/79) at `a9d3e68`: lifecycle/migration proof, computed V1 precedence and numeric contrast, actual public Agent PATCH-to-same-workspace preview DOM/computed-style proof with sensitivity control, restart/replay retention, redacted response diagnostics, and honest unknown/not-reproduced Firefox evidence. Active 078/3 closes the unqualified Chrome scan-coverage gap and retains failed-scan diagnostics; global-region, exact-workspace Puck, review, and publication remain outside this slice. | PARTIAL | Independently review and accept/merge the bounded 078/3 maintenance increment; preserve the merged 078/1 and 078/2 evidence |
...
| 078 source revision | Public capability-bound catalog composition data plane plus the accepted 078/1 design-system/local variant-layout-responsive extension merged in PR #77; 078/2 site-theme trusted-boundary repairs are separately active in 078-q | Remaining V1–V2/Firefox rendering evidence, global-region/page-style/catalog semantics, exact-workspace Puck, media references, MCP, freeze/review, promotion/publication, source reconstruction, cleanup, backup/restore, or contractual MVP completion |
  ...
  -> 074 human Agent workspace/capability product surface
      -> 075 complete editable-domain substrate and shared validators
          -> 076 Agent model/content/view/relation REST+OpenAPI
              -> 077 page/navigation/redirect/dynamic-Render (PR74 merged ae3a4a6)

ACTIVE / REMAINING AFTER MERGED 077:
078/1 on merged PR77 is bounded to components and local design; its final audit
findings and security continuation were accepted and merged at `3cae3d6`.
078/2 is the separate active 078-q theme-boundary increment. 078-i theme history is
preserved and reused only within that bounded continuation.
...
bounded semantic merge increment maps to one PR; a numeric objective may span
sequential PRs when a strategic continuation explicitly orders it.
