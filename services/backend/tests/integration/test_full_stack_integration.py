...
class TestFullStackWiring:
    ...
    def test_content_model_service_is_complete(self) -> None:
        ...
        expected_methods = [
            "create_type", "list_types", "get_type", "update_type", "delete_type",
            "create_field", "list_fields", "get_field",
            "update_field", "delete_field",
            "create_item", "list_items", "get_item", "update_item", "delete_item",
            "create_view", "list_views", "get_view",
            "update_view", "delete_view",
            "create_page", "list_pages", "get_page",
            "update_page", "delete_page",
            "create_navigation", "list_navigation", "get_navigation",
            "update_navigation", "delete_navigation",
            "get_theme", "update_theme",
            "add_composition_node", "update_composition_node",
            "move_composition_node", "delete_composition_node",
            "list_composition",
            "create_media", "list_media", "get_media",
