...
NEW_PACKAGE_FILES = {
    ...
    "slaif_agent_site/agent_api/browser_http.py",
    ...
    "slaif_agent_site/content_model/bounded_embed.py",
    ...
    "slaif_agent_site/browser_preview_credentials.py",
    "slaif_agent_site/browser_worker_client.py",
    ...
    "slaif_agent_site/db/alembic/versions/036_001_render_browser_preview_authority.py",
    ...
    "slaif_agent_site/db/alembic/versions/041_001_agent_semantic_audit.py",
    ...
    "slaif_agent_site/db/alembic/versions/053_001_locale_route_integrity.py",
    "slaif_agent_site/db/alembic/versions/054_001_preview_recheck_modes.py",
    "slaif_agent_site/db/alembic/versions/055_001_redirect_dependency_cow_tombstone.py",
    "slaif_agent_site/db/alembic/versions/056_001_dynamic_render_collection_contract.py",
    "slaif_agent_site/db/alembic/versions/057_001_navigation_dynamic_route_integrity.py",
    "slaif_agent_site/db/alembic/versions/058_001_internal_navigation_dependencies.py",
    ...
    "slaif_agent_site/db/alembic/versions/062_001_component_authority_repairs.py",
    "slaif_agent_site/db/alembic/versions/063_001_component_audit_repairs.py",
...
EXPECTED_PACKAGE_FILES = NEW_PACKAGE_FILES | {
    ...
    "slaif_agent_site/content_model/site_data_models.py",
    "slaif_agent_site/content_model/site_data_validators.py",
    "slaif_agent_site/editor_api/domain_http.py",
    "slaif_agent_site/editor_api/site_data_http.py",
    ...
    "slaif_agent_site/content_model/component_catalog.py",
...
EXPECTED_SDIST_FILES = {
    ...
    "services/backend/src/slaif_agent_site/editor_api/site_data_http.py",
    ...
    "services/backend/src/slaif_agent_site/browser_worker_client.py",
    "services/backend/src/slaif_agent_site/agent_api/browser_http.py",
    "services/backend/src/slaif_agent_site/agent_api/browser_service.py",
    "services/backend/src/slaif_agent_site/db/alembic/versions/036_001_render_browser_preview_authority.py",
