...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ("058_001", "058_001", "PENDING", False, "agent-cow-postgresql", "0.2.0"),
            ControlDatabaseReason.UNSAFE_MARKER,
        ),
        (
            ("058_001", "058_001", "EMPTY_SAFE", True, "other", "0.2.0"),
            ControlDatabaseReason.FOUNDATION_MISMATCH,
        ),
        (
            ("058_001", "058_001", "HARDENED", True, "agent-cow-postgresql", "0.1.0"),
            ControlDatabaseReason.FOUNDATION_MISMATCH,
        ),
    ),
)
