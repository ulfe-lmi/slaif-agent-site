...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ("041_001", "041_001", "PENDING", False, "agent-cow-postgresql", "0.2.0"),
            ControlDatabaseReason.UNSAFE_MARKER,
        ),
        (
            ("041_001", "041_001", "EMPTY_SAFE", True, "other", "0.2.0"),
            ControlDatabaseReason.FOUNDATION_MISMATCH,
        ),
        (
            ("041_001", "041_001", "HARDENED", True, "agent-cow-postgresql", "0.1.0"),
            ControlDatabaseReason.FOUNDATION_MISMATCH,
        ),
    ),
)
