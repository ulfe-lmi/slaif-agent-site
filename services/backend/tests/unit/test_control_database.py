...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ("006_001", "016_001", "EMPTY_SAFE", True, "agent-cow-postgresql", "0.2.0"),
            ControlDatabaseReason.MIGRATION_MISMATCH,
        ),
        (
            ("016_001", "006_001", "EMPTY_SAFE", True, "agent-cow-postgresql", "0.2.0"),
            ControlDatabaseReason.MIGRATION_MISMATCH,
        ),
        (
            ("016_001", "016_001", "PENDING", False, "agent-cow-postgresql", "0.2.0"),
            ControlDatabaseReason.UNSAFE_MARKER,
        ),
        (
            ("016_001", "016_001", "EMPTY_SAFE", True, "other", "0.2.0"),
            ControlDatabaseReason.FOUNDATION_MISMATCH,
        ),
        (
            ("016_001", "016_001", "HARDENED", True, "agent-cow-postgresql", "0.1.0"),
            ControlDatabaseReason.FOUNDATION_MISMATCH,
        ),
    ),
)
