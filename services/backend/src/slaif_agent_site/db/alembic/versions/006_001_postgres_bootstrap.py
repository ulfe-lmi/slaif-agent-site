...
def upgrade() -> None:
    ...
    op.execute(
        ...
        CREATE TABLE "control"."bootstrap_readiness" (
            ...
            "cow_deployed" boolean NOT NULL DEFAULT FALSE,
            "cow_hardened" boolean NOT NULL DEFAULT FALSE,
            "privileges_validated" boolean NOT NULL DEFAULT FALSE,
            "safe" boolean NOT NULL DEFAULT FALSE,
            "updated_at" timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
            CHECK (NOT "safe" OR (
                "cow_deployed" AND "cow_hardened" AND "privileges_validated"
            ))
        )
        """
    )
