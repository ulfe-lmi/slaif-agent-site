...
| `browser-worker` | Playwright 1.62.1 / Chrome for Testing 153.0.8010.36 (CfT revision 1681091) | `10001:10001` | browser only | read-only worker credential; writable private browser artifacts |
...
`playwright-core==1.62.1` and bakes only Chrome for Testing `153.0.8010.36`
