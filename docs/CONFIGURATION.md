...
| `BROWSER_WORKER_CHROMIUM_EXECUTABLE` | `/ms-playwright/chromium-1681091/chrome-linux64/chrome` | Image-fixed executable |
| `BROWSER_WORKER_EXPECTED_CHROMIUM_VERSION` | `153.0.8010.36` | Readiness version assertion |
